...
# --- XỬ LÝ DỮ LIỆU & ĐẢO NGƯỢC THÔNG SỐ THEO YÊU CẦU ---
def process_data(file):
    ...
    # ĐẢO NGƯỢC: Nhiệt độ lấy từ humiKK, Độ ẩm lấy từ tempKK
    ...
    if uploaded_file:
        ...
        if not df.empty:
            ...
            if not df_valid.empty:
                ...
                st.error("🚨 Không có trạm nào chứa dữ liệu độ ẩm/nhiệt độ.")
        else:
